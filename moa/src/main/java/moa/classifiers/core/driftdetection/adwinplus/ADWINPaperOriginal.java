 ...
 */
public class ADWINPaperOriginal {
     //extends Estimator {
...
//			temp = this.tail;
    ...
    private class ListItem {
        ...
        protected int MAXBUCKETS = ADWINPaperOriginal.MAXBUCKETS;
...
//			 object.
    ...
    public ADWINPaperOriginal(double d) {
        mdbldelta = d;
        initBuckets();
        Detect = 0;
        numberDetections = 0;
    ...
    public ADWINPaperOriginal(int cl) {
        mdbldelta = DELTA;
        initBuckets();
        Detect = 0;
        numberDetections = 0;
