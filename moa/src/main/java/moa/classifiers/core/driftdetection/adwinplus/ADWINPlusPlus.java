package moa.classifiers.core.driftdetection.adwinplus;

//import de.tub.bdapro.adwin.core.histogram.Bucket;
//import de.tub.bdapro.adwin.core.histogram.Histogram;
import moa.classifiers.core.driftdetection.SequentialADWINImpl;
import moa.classifiers.core.driftdetection.adwinplusutils.Bucket;
 ...
 */
public abstract class ADWINPlusPlus {
    ...
    public ADWINPlusPlus(double delta, int safe_lim, int min_lim, int max_lim, int theta, int omega) {
        this.delta = delta;
        this.minKeepSize = 7;
        this.minCutSize = 7;
